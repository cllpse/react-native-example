...
export enum FontFamily {
  Paragraph = 'GTAmerica-Regular',
  ParagraphBold = 'GTAmerica-Bold',
  Highlight = 'GTAmerica-Regular',
  Heading = 'GTAmerica-CompressedBold',
  HeadingSmall = 'GTAmerica-CompressedBold',
  Caption = 'GTAmerica-ExtendedBold',
  Button = 'GTAmerica-ExtendedBold'
}

export enum FontSize {
  Paragraph = 14 * SizeFactorial,
